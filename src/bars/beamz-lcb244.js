...
export default parseFixtureConfig({
    ...
    modes: [
        ...
        },
        {
            name: "16ch",
            props: [
                {type: "dimmer", repeats: 2, every: 7, activeDefault: 255, ui: false},
                {type: "strobe", repeats: 2, every: 7},
        ...
        },
        {
            name: "30ch",
            props: [
                {type: "dimmer", repeats: 4, every: 7, activeDefault: 255, ui: false},
                {type: "strobe", repeats: 4, every: 7},
        ...
        },
        {
            name: "58ch",
            props: [
                {type: "dimmer", repeats: 8, every: 7, activeDefault: 255, ui: false},
                {type: "strobe", repeats: 8, every: 7},
